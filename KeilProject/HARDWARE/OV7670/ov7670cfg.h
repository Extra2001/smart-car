...
const u8 ov7670_init_reg_tbl[][2] =
	{
		...
		{0x3a, 0x04}, // dummy
		{0x40, 0xd0}, // 565
		{0x12, 0x14}, // 14 QVGA,RGB输出  04 VGA,RGB

		//输出窗口设置
		{0x32, 0x80}, // HREF control	bit[2:0] HREF start 3 LSB	 bit[5:3] HSTOP HREF end 3LSB
		{0x17, 0x16}, // HSTART start high 8-bit MSB    	16 QVGA, 14 VGA
		{0x18, 0x04}, // 5 HSTOP end high 8-bit						04 QVGA, 02 VGA
		{0x19, 0x02},
		{0x1a, 0x7b}, // 0x7a,														7b QVGA, 7a VGA
		{0x03, 0x06}, // 0x0a,帧竖直方向控制							06 QVGA, 0a VGA
