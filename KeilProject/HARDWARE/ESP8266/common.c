...
//连接端口号:8080,可自行修改为其他端口.//8086
const u8 *portnum = "9020";
const u8 *wifista_ip = "192.168.1.102";
//远端IP
// dwz 		192.168.1.113
// zc			192.168.1.117
//小车专用	192.168.10.100
//演示			192.168.1.100
// 626				192.168.1.1 //TP-LINK路由器管理页面密码626626

// WIFI STA模式,设置要去连接的路由器无线参数,请根据你自己的路由器设置,自行修改.
const u8 *wifista_ssid = "SmartCar627";
//路由器SSID号
// dwz	TP-LINK_ED58
// zc 			TP-LINK_E3D0
//小车专用	xiaoche
...
const u8 *wifista_password = "627627627";
//连接密码
// dwz 		twm24680
// zc			tushuguan
//小车专用	zhinengxiaoche
