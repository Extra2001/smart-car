...
void TIM8_Int_Init(u16 arr,u16 psc)
{
    ...
    TIM_ITConfig(  TIM8,TIM_IT_Update  |  TIM_IT_Trigger,  ENABLE  );//使能更新触发TIM中断

    //中断分组设置
    NVIC_InitStructure.NVIC_IRQChannel = TIM8_TRG_COM_IRQn;  //TIM3中断
...
void TIM8_IRQHandler(void)   //TIM3中断
{
